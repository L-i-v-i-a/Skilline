    ...
    <div className="space-y-10 animate-fade-in">
      ...
      <header>
        ...
        <p className="text-gray-400 font-medium mt-2">
          You have{" "}
          <span className="text-[#F97316] font-bold">2 assignments</span> due
        ...
        <div className="lg:col-span-2 bg-white rounded-[2.5rem] p-8 shadow-sm border border-gray-100">
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row items-center gap-6 p-4 rounded-[2rem] hover:bg-slate-50 transition-colors border border-transparent hover:border-slate-100">
              <div className="w-full md:w-32 h-24 bg-[#2D3162] rounded-2xl flex items-center justify-center text-3xl">
                💻
              </div>
              <div className="flex-1 w-full text-center md:text-left">
                <h4 className="font-bold text-[#2D3162] text-lg">
              ...
              <button className="bg-[#2D3162] text-white px-6 py-3 rounded-xl font-bold text-sm">
                Resume
              </button>
            </div>
          </div>
