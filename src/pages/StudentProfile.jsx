  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="bg-white rounded-[2.5rem] p-8 shadow-sm border border-gray-100 flex flex-col md:flex-row items-center gap-8">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-gray-400 font-medium">
            @{profileData?.username} • {profileData?.major || "Student"}
          </p>
      ...
      <div className="bg-white rounded-[2.5rem] p-8 md:p-12 shadow-sm border border-gray-100">
        <div className="mb-10">
          <h2 className="text-2xl font-bold text-[#2D3162]">
            Account Settings
          </h2>
          <p className="text-gray-400">
            Keep your personal details up to date for better course
            recommendations.
          </p>
        </div>

        {success && (
          <div className="mb-6 p-4 bg-green-50 text-green-700 rounded-2xl border-l-4 border-green-500 font-medium animate-fade-in">
            {success}
          </div>
        )}
        {error && (
          <div className="mb-6 p-4 bg-red-50 text-red-700 rounded-2xl border-l-4 border-red-500 font-medium animate-fade-in">
            {error}
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <label className="block text-sm font-bold text-[#2D3162] mb-2 ml-1 uppercase tracking-widest">
              About Me (Bio)
            </label>
            <textarea
              name="bio"
