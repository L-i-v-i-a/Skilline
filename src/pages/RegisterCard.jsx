...
const RegisterCards = () => {
  return (
    <section className="relative py-24 bg-[#FFF2E1] overflow-hidden">
      <div className="w-full px-4 md:px-10 lg:px-16 flex flex-col md:flex-row justify-center items-center gap-10 lg:gap-16">
        ...
        <div className="group relative w-full max-w-[480px] h-[320px] rounded-[30px] overflow-hidden shadow-2xl transition-transform duration-500 hover:-translate-y-4 animate-float">
          ...
          <div className="relative h-full flex flex-col items-center justify-center text-center px-8">
            ...
            <button className="bg-[#23BDEE] text-white px-8 py-4 rounded-full font-bold text-lg shadow-lg hover:bg-[#1da8d6] transition-all active:scale-95">
              Register as Student
            </button>
          </div>
        </div>
        ...
        <div className="group relative w-full max-w-[480px] h-[320px] rounded-[30px] overflow-hidden shadow-2xl transition-transform duration-500 hover:-translate-y-4 animate-float delay-300">
          ...
          <div className="relative h-full flex flex-col items-center justify-center text-center px-8">
            ...
            <button className="bg-white text-[#2F327D] px-8 py-4 rounded-full font-bold text-lg shadow-lg hover:bg-gray-100 transition-all active:scale-95">
